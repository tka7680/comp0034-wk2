...
#Initialise SQLAlchemy extension
...
def create_app(test_config=None):
    ...
    app.config.from_mapping(
        #SECRET_KEY='dev',
        #Creates a new secret key according to Step 1.3
        SECRET_KEY='i9H_cFF3PdnK7BWhItxCoQ',
    ...
    #Step 1.5: Ensures app knows about routes defined in paralympics.py
...
#Add data to the database step 1
